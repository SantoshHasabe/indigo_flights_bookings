...
function validateCreateRequest(req, res, next) {
    ...
    if(!req.body.flightNumber) {
        ...
        ErrorResponse.error = new AppError(['Airport flightNumber not found in the oncoming request in the correct form'], StatusCodes.BAD_REQUEST);
        return res
    ...
    if(!req.body.airplaneId) {
        ErrorResponse.message = 'Something went wrong while creating flight';
        ErrorResponse.error = new AppError(['Airport airplaneId not found in the oncoming request in the correct form'], StatusCodes.BAD_REQUEST);
        return res
                .status(StatusCodes.BAD_REQUEST)
                .json(ErrorResponse);
    }
